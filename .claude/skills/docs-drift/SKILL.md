...
- Don't try to refresh ported pages automatically — they need hand-fixing for link/image churn. Re-port with `scripts/port-page`, whose header lists what it leaves for a manual pass (cross-section links, residual ERB, images).
