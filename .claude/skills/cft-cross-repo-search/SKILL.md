...
- Taxonomy-keyed questions ("all services using Notice of Change") — use `INDEX.md` via `/cft-ccd-find-feature` or `/cft-list-integrations`. Those are O(1); ripgrep is O(many GB).
