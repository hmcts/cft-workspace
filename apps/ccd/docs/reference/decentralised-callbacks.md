...
2. CCD's existing message publisher service can be reused and deployed by decentralised services for the actual publishing step. <!-- CONFLUENCE-ONLY: deployment/reuse pattern from the LLD; not verified in source. -->
