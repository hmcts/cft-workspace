...
Use the [HMCTS Cookie Manager library](https://github.com/hmcts/cookie-manager) to manage consent.

### Cookie options

- Secure - in production ensure `Secure` is set
- SameSite - use `Strict` unless you need `Lax` for an [Oauth implementation](https://github.com/simov/grant/issues/199),
