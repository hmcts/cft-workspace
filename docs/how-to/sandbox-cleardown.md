...
The [#sandbox-cleardown (Slack)](https://hmcts-reform.slack.com/archives/C04PBAYU35E) slack channel has been created to post warning messages about resources that are scheduled to be cleared down in the sandbox environment.

Once a resource has been deleted, an alert will be posted in the channel.
