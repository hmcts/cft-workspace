...
3. Managed Identities can be created by using the [cnp-module-keyvault](https://github.com/hmcts/cnp-module-key-vault#application-access-using-managed-identities) terraform module.
