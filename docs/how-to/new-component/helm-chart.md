...
[person onboarding doc](../../tutorials/cnp-onboarding/person.md#the-following-tools-are-commonly-used).
...
Ask on [#platops-help (Slack)](https://hmcts-reform.slack.com/app_redirect?channel=platops-help) on slack for someone to setup the pipeline for you in AzureDevOps.
