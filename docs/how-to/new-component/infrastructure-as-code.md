...
All our infrastructure is public cloud-based. We use [Terraform](https://www.terraform.io/docs/index.md) to manage infrastructure as code.
...
Sensitive information such as passwords and key pairs should neither be managed by Terraform nor present in GitHub and instead retrieved from a Key Vault. See [secrets management](secrets-management.md) for more information.
