...
Feature flags enable a team to deliver new features to use rapidly but safely.
...
Trunk Based Development is a branching model in which developers create short-lived feature branches and merge back into the “trunk” branch, often called the master/main branch.
...
Documentation can be accessed directly from the [LaunchDarkly](https://launchdarkly.com/docs/home) website.
...
We currently provide 'Test' and 'Production' environments by default within Launch Darkly. Flags are generally set to the same value in both 'Production' and the 'Test' environment, [flag targeting](https://launchdarkly.com/docs/guides/flags) is used to control rollout of flags to users across environments.
