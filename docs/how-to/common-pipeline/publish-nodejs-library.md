...
> All libraries are published under the `hmcts` scope, make sure your library name starts with `@hmcts/my-lib`, see [nodejs-logging](https://github.com/hmcts/nodejs-logging/blob/28eedc42475b06dce207ecc4dc86c4ceaea39a89/package.json#L2)
...
9. Check the library was released to [https://npmjs.com](https://npmjs.com)

Further information on NPM can be found at [https://docs.npmjs.com/](https://docs.npmjs.com/).
