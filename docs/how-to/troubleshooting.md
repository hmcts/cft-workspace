...
- See [GitHub Onboarding](../tutorials/cnp-onboarding/team-github.md#access) for how to get access
...
See [create a GitHub repository](new-component/github-repo.md)
...
- If no one from your team have access, follow asking for help (the upstream "asking for help" page was not ported; raise a [#platops-help (Slack)](https://hmcts-reform.slack.com/app_redirect?channel=platops-help) request instead) to request org admins in one of the community/ support channels.
...
If your account has been deleted and you need it re-enabled, you need to create a ticket via slack in the [#platops-help (Slack)](https://hmcts-reform.slack.com/app_redirect?channel=platops-help) channel and someone will send you another guest invite.

Once that is done you will then be able to get your GitHub access back by asking one of your team members to re-add you following [person onboarding](../tutorials/cnp-onboarding/person.md).
...
### Cannot login to Jenkins
  ...
  - Login to Jenkins is managed by Microsoft Entra ID, please make sure user is added to right [Microsoft Entra ID groups](../tutorials/cnp-onboarding/person.md#microsoft-entra-id-groups)
...
### Cannot see my new repo in Jenkins org / Dashboard
  ...
  - See [Jenkins Onboarding section](../tutorials/cnp-onboarding/team-jenkins.md#jenkins) to add your app to Jenkins Org / Dashboard
...
See the instructions on the [slack](../tutorials/cnp-onboarding/team-slack.md) section of the onboarding guide to find out how to do this.
...
If you’re still having issues then please raise a ticket in the [#platops-help (Slack)](https://hmcts-reform.slack.com/app_redirect?channel=platops-help) channel.
