---
title: Migrating from `cnp-module-redis` to `terraform-module-azure-managed-redis`
topic: migrating-to-managed-redis
diataxis: how-to
product: workspace
audience: both
---
...
[Input files](https://github.com/hmcts/terraform-module-azure-managed-redis/blob/e018f031e653e66d226dbde406d7eb39c39e241e/inputs-optional.tf)

[Azure Managed Redis Docs](https://learn.microsoft.com/en-us/azure/redis/)

[Terraform Managed Redis Docs](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/managed_redis)

## Quick navigation

- [Feature parity](#feature-parity)
- [Quick Start](#quick-start)
- [Data migration instructions](#data-migration-instructions)
- [Key differences at a glance](#key-differences-at-a-glance)
- [Input mapping](#input-mapping)
- [Output mapping](#output-mapping)
- [SKU reference](#sku-reference)
- [Fine-grained Migration steps](#fine-grained-migration-steps)
- [Variables to add / remove from `variables.tf`](#variables-to-add--remove-from-variablestf)
- [Gotchas /Troubleshooting:](#gotchas-troubleshooting)

## Feature parity
While MS is ending support for Az Cache for Redis, there is not complete feature parity between the offerings.

Please investigate & test these carefully as documentation from MS is hit or miss.
[MS Migration Docs](https://docs.azure.cn/en-us/redis/migrate/migrate-basic-standard-premium-understand)
...
> We have an agent skill which can assist you through the migration process. It will allow your agentic AI to assist and create Terraform and Flux PRs more easily.
Check it out here!
platops-agent-skills [ azure-managed-redis-migration](https://github.com/hmcts/platops-agent-skills/tree/main/.github/skills/azure-managed-redis-migration) .
...
Example PRs:
  ...
  - [Plum example change](https://github.com/hmcts/cnp-plum-recipes-service/blob/master/infrastructure/main.tf#L155-L174)
...
3) Update application/ code to target the new resource
  ...
  Please see this reference [PR](https://github.com/hmcts/cnp-flux-config/pull/45044/changes) for how to switch connection string using flux config.  It uses a new Key Vault secret but same variable name for the application.
  

## Data migration instructions

If data migration is required, please follow the instructions [here](https://hmcts.github.io/ops-runbooks/Services/migrating-azure-redis-cache.html)

## Key differences at a glance

| Concern | `cnp-module-redis` | `terraform-module-azure-managed-redis` |
|---|---|---|
| Redis tier (See Azure docs [here](https://learn.microsoft.com/en-us/azure/redis/overview#choosing-the-right-tier) )| Basic / Standard / Premium | Performant SKUs are still very expensive! Balanced / ComputeOptimized / MemoryOptimized / FlashOptimized |
...
The backward-compatible aliases allow you to rename the module block without updating every
downstream reference at once.

---

## SKU reference

[NEW Managed Redis - pricing ](https://azure.microsoft.com/en-us/pricing/details/managed-redis/)

[OLD Azure Cache for Redis - pricing](https://azure.microsoft.com/en-gb/pricing/details/cache/)
...
<span id="variables-to-add--remove-from-variablestf"></span>
