...
- CFT Platform: [load balancer config](https://github.com/hmcts/azure-platform-terraform/blob/master/environments/prod/backend_lb_config.yaml)
- SDS Platform: [load balancer config](https://github.com/hmcts/sds-azure-platform/blob/master/environments/prod/backend_lb_config.yaml)

Frontend applications are automatically handled as part of the
[front door config](front-door.md),
that config provides all the information we need for setting up the load balancer,
so frontend applications skip the above step.
