...
For repository scanning, deployment controls and GitHub topics, use [Jenkins setup](../../how-to/new-component/jenkins-repository.md).

## Team metadata required for pipelines

Each team needs configuration in the [team-config](https://github.com/hmcts/cnp-jenkins-config/blob/master/team-config.yml) file
in the cnp-jenkins-config repository.

Send a [pull request](https://help.github.com/en/github/collaborating-with-issues-and-pull-requests/about-pull-requests) with your configuration.
