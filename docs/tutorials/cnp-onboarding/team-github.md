...
1. If someone in your team already has access then ask them to follow the instructions on the [Person onboarding](../person/) document to add you.
2. If you're the first person in your team you should raise a help request in [#platops-help (Slack)](https://hmcts-reform.slack.com/archives/C8SR5CAMU), asking for GitHub access, and say that you agree to the [Acceptable Use Policy (Confluence)](https://tools.hmcts.net/confluence/display/RPE/Acceptable+Use+Policy+and+Contractor+Security+Guidance).
...
- Link this team to your Microsoft Entra ID group created as part of [Microsoft Entra ID onboarding](team-azuread.md). This will mean your team members are automatically added when they join.

3. Create a team called \<team-name>-admins

see also [creating a GitHub repository](../../how-to/new-component/github-repo.md#create-a-github-repository).
