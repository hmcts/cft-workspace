...
The first user in a team should raise a [#platops-help (Slack)](https://hmcts-reform.slack.com/app_redirect?channel=platops-help) request with the required groups.

To start with send the [acceptable use policy (Confluence)](https://tools.hmcts.net/confluence/display/RPE/Acceptable+Use+Policy+and+Contractor+Security+Guidance) to the new starter.
...
- [VPN](https://portal.platform.hmcts.net)
- [LaunchDarkly](../../how-to/new-component/feature-flags.md#accessing-launchdarkly)
- the [Azure Portal](https://portal.azure.com/)
- application logs
- [GitHub](https://github.com/orgs/hmcts/sso)

Being a member of the `DTS CFT/SDS Developers` groups will allow you to request the [access package](https://myaccess.microsoft.com/@CJSCommonPlatform.onmicrosoft.com#/access-packages/e7cbb8d7-bd25-4d5a-8bbc-c94c03f1c827) that adds you to our list of people with security clearance.
...
Once you've joined the `DTS GitHub Access` Microsoft Entra ID group you will be able to join GitHub from your [myapps.microsoft.com](https://myapps.microsoft.com/hmcts.net) dashboard.

GitHub teams are managed either by being [linked to a team Microsoft Entra ID group](https://docs.github.com/en/enterprise-cloud@latest/organizations/organizing-members-into-teams/synchronizing-a-team-with-an-identity-provider-group)
or by a senior member of the team, ask them to add you to any team groups.

Once you've joined GitHub make sure you add your user to the [Slack -> GitHub mapping](https://github.com/hmcts/github-slack-user-mappings).
...
Often there's a `$team-developers@hmcts.net` and a `$team@hmcts.net` group.
...
To use the docker cli with your account, you will need to set up a Personal Authentication Token (PAT). See [docker documentation](https://docs.docker.com/docker-hub/access-tokens/) for how to create a PAT.
...
- How, when and where to ask for help: raise a [#platops-help (Slack)](https://hmcts-reform.slack.com/app_redirect?channel=platops-help) request — the upstream "asking for help" page was not ported into this workspace.
...
- an IDE (e.g. IntelliJ or Visual Studio Code)
...
Join the [developers Slack channel](https://hmcts-reform.slack.com/messages/developers)
