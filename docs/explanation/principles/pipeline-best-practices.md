...
When starting a new project, the preferred approach is to adopt the [Jenkins Common Pipeline](../../how-to/common-pipeline/overview.md) rather than building a new pipeline from scratch.
