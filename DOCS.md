...
| pcs | explanation | Group Access and Notice of Change | group-access | `apps/pcs/docs/explanation/group-access-and-noc.md` |
...
| pcs | how-to | Test Notice of Change on a preview | group-access | `apps/pcs/docs/how-to/test-notice-of-change-on-a-preview.md` |
